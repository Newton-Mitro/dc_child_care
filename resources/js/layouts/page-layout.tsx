...
export default function PageLayout({ children, ...props }: PageLayoutProps) {
    ...
    return (
        <div className="relative flex min-h-screen flex-col bg-background" {...props}>
            ...
            <div className="fixed -right-44 -bottom-10 z-20 hidden md:block">
                <img src="/images/panda.png" alt="Decorative element" className="w-[500px] opacity-80" />
            </div>

            {/* Animated shapes */}
            <div className="fixed bottom-5 left-5 z-10 animate-[bounce_3s_ease-in-out_infinite]">
                <img src="/images/turtle.png" alt="Decorative element" className="w-20 animate-[spin_10s_ease-in-out_infinite] md:w-full" />
            </div>

            {/* <div className="fixed bottom-5 left-0 z-20 w-full">
            ...
            {showModal && (
                <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/60">
                    <div className="relative w-4xl rounded-lg p-6 text-center">
                        ...
                        <div className="rounded-2xl bg-card p-6">
                            <img src="./images/ads.jpg" alt="Logo" className="w-4xl rounded" />
                        </div>
                    </div>
                </div>
            )}
